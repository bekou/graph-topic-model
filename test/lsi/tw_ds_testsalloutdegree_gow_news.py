...
def printAccuracies(data_train, data_test ,lab_col,dataset):
	...
	centrality_pars = ["out_degree_centrality"]
			...
			for i in range(len(comp)):
					...
					try:
						...
						for z in range(len(alphas)):
							...
							#joblib.dump(ypred, 'results85%/sgd/'+dataset+"_"+normal+"_"+str(comp[i])+"_"+str(centrality_par)+'_'+str(sliding_window)+"_sgd_pred.pkl") 	
